...
async function appendSnapshot(projectId: string, live: GithubSnapshotPayload): Promise<void> {
  await prisma.githubRepoSnapshot.create({
    data: {
      ...
      defaultBranch: live.defaultBranch ?? undefined,
      stars: live.stars,
      forks: live.forks,
      ...
      commitCount7d: 0,
      commitCount30d: 0,
      contributorsCount: live.contributorsCount ?? undefined,
      lastCommitAt: live.lastCommitAt ?? undefined,
      latestReleaseTag: live.latestReleaseTag ?? undefined,
      latestReleaseAt: live.latestReleaseAt ?? undefined,
    },
  });
}
